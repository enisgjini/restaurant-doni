...
<div class="container">
	<h1 class="page-header text-center">Lista e produkteve</h1>
	<div class="row">
		<div class="col-md-12">
			...
			<a href="#addproduct" data-toggle="modal" class="pull-right btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Shto nje produkt</a>
		</div>
	</div>
				...
				<?php
					...
					while($row=$query->fetch_array()){
						...
						<tr>
							...
							<td>
								<a href="#editproduct<?php echo $row['productid']; ?>" data-toggle="modal" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-pencil"></span> Ndrysho</a> || <a href="#deleteproduct<?php echo $row['productid']; ?>" data-toggle="modal" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span> Fshij</a>
